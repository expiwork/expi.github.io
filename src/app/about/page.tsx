...
export const metadata = {
  title: "درباره ما | اکسپی",
  description:
    "درباره اکسپی - پلتفرم اشتراک‌گذاری تجربه کاری در شرکت‌های ایرانی",
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-muted/50">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-8">درباره اکسپی</h1>

          <Card>
            <CardContent className="prose prose-lg dark:prose-invert max-w-none p-6">
              <p>
                اکسپی یک پلتفرم آزاد و متن‌باز برای اشتراک‌گذاری تجربیات کاری در
              ...
              <h2>مشارکت</h2>
              <p>
                اکسپی یک پروژه متن‌باز است و از مشارکت همه استقبال می‌کند. برای
